...
if ($_SERVER['REQUEST_METHOD'] == "POST"){
  ...
  if($count>0){
    ...
    if($password!=$c_pass)
    {
      ...
      $insert="INSERT INTO users(name, username, password) VALUES('$name','$username', '$check_pass')";
...
<body>
  ...
  <div class="container-fluid mt-4">
    ...
    <div class="row">
      ...
      <div class="col-5">
        <img class="card-img-top" src="images\studentReg.svg" alt="Card image cap">
      </div>

      <div class="col-6">

        <div class="container mt-4">
          <h3>Please Register Here as a student: </h3>
          <hr>
